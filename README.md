...
?? [Download der aktuellen Version](https://github.com/es3006/ESD-Zeiterfassung-1.0.0.5/releases/latest)
...
**Einstellungen:**
![Settings Dialog](docs/screenshots/settings-window.png)


**Koordinaten:**
![Settings Dialog](docs/screenshots/coordinates-window.png)
